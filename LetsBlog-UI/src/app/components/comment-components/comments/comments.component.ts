...
import { BlogCommentViewModel } from 'src/app/models/blog-comment/blog-comment-view-mode.model';
...
export class CommentsComponent implements OnInit {
    ...
    constructor(public accountService: AccountService, private toastr: ToastrService, private blogCommentService: BlogCommentService) {}
